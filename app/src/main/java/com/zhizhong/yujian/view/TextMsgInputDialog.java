package com.zhizhong.yujian.view;
...
//    private Pattern pattern = Pattern.compile(reg);
    ...
    public TextMsgInputDialog(Context context, int theme) {
        ...
        messageTextView = (EditText) findViewById(R.id.et_live_room_content);
        ...
        confirmBtn = (TextView) findViewById(R.id.tv_live_room_send);
...
//                            messageTextView.setText("");
        ...
        rlDlg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(v.getId() != R.id.ll_live_room_content)
                    dismiss();
            }
        });

        final LinearLayout rldlgview = (LinearLayout) findViewById(R.id.ll_live_room_content);
