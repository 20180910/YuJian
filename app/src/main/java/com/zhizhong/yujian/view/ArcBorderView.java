...
public class ArcBorderView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if(attrs!=null){
            ...
            circleColor= typedArray.getColor(R.styleable.ArcBorderView_circleColor, Color.TRANSPARENT);
...
//        mPaint.setColor(borderColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Path circlePath=new Path();//绘制凸出部分的颜色
        circlePath.set(arcPath);
    ...
    public ArcBorderView setCircleColor(int circleColor) {
