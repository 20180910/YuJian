...
public class ExampleUnitTest {
    ...
    @Test
    public void y2yang() throws Exception {
        Lunar lunar=new Lunar();
        lunar.lunarYear=2002;
        lunar.lunarMonth=4;
        lunar.lunarDay=1;
        System.out.println(lunar.isleap);
        Solar new_solar =LunarSolar.LunarToSolar(lunar);
        System.out.println(new_solar);
    }
    @Test
    public void rili() throws Exception {
        ...
        newLunar.lunarYear=2002;
        newLunar.lunarMonth=4;
        newLunar.lunarDay=1;
//        lunar.isleap = false;
        Solar new_solar = LunarSolar.LunarToSolar(newLunar);
